...
class InterviewStartPolicyTest {
    ...
    void testValidateWhenUserExceededDailyLimit() {
        ...
        assertThatThrownBy(() -> interviewStartPolicy.validate(member.getId(), MainCategory.COMPUTER_SCIENCE))
    ...
    void testValidateWhenAdminExceededDailyLimit() {
        ...
        assertThatCode(() -> interviewStartPolicy.validate(admin.getId(), interview.getMainCategory()))
    ...
    void testValidateWhenUserStartsDifferentCategory() {
        ...
        assertThatCode(() -> interviewStartPolicy.validate(member.getId(), MainCategory.SYSTEM_DESIGN))
                .doesNotThrowAnyException();
    }
}
